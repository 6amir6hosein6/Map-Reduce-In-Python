...
print('%s\t%s' % (sorted(list,key=lambda x: x[1])[0][0], sorted(list,key=lambda x: x[1])[0][1]))
print('%s\t%s' % (sorted(list,key=lambda x: x[1])[-1][0], sorted(list,key=lambda x: x[1])[-1][1]))